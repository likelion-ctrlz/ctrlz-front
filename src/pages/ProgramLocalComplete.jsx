  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-5 pb-[130px]">
        ...
        <p className="text-[14px] text-[#C6F3E7] m-0 mb-8 text-center">토큰을 사용하여 활동이 예약되었어요</p>
        ...
        <div className="relative w-full max-w-[273px]">
          ...
          <div className="relative px-6 py-7" style={{ filter: "drop-shadow(0px 4px 20px rgba(0, 0, 0, 0.08))" }}>
            ...
            <div className="relative z-10">
              <p className="text-[24px] font-bold text-[#00CB93] text-center m-0 mb-6">신청 내역</p>
              ...
              <p className="text-[12px] text-[#CACACA] text-center mt-5 m-0" style={{ fontFamily: "'Neuropolitical', sans-serif" }}>Morrow</p>
            </div>
          </div>
        </div>
