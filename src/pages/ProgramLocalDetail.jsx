      ...
      <main className="flex-1 overflow-y-auto pb-[130px]">
        ...
        <div className="mx-5 mt-5 bg-[rgba(184,184,184,0.08)] rounded-[16px] px-5 py-4">
          <div className="space-y-4">
            <div>
              ...
              <p className="text-[11px] text-gray-muted m-0 mt-1">2025년 7월 5일 ~ 2026년 9월 30일 (매주 토요일)</p>
            </div>
            <div>
              <p className="text-[12px] font-medium text-black m-0">장소</p>
              <p className="text-[11px] text-gray-muted m-0 mt-1">강동구 문화예술회관 3층 공예실</p>
            </div>
            <div>
              <p className="text-[12px] font-medium text-black m-0">소요 시간</p>
              <p className="text-[11px] text-gray-muted m-0 mt-1">오전 10:00 ~ 12:00</p>
            </div>
            <div>
              <p className="text-[12px] font-medium text-black m-0">정원</p>
              <p className="text-[11px] text-gray-muted m-0 mt-1">회차당 15명</p>
            </div>
          </div>
        </div>
        ...
        <div className="px-5 mt-8">
          ...
          <div className="bg-[rgba(184,184,184,0.08)] rounded-[16px] px-5 py-4 mb-4">
            ...
            <p className="text-[11px] text-gray-muted m-0">전화 문의 02 - 000 - 0000 (평일 09:00 ~ 18:00)</p>
            <p className="text-[11px] text-gray-muted m-0 mt-2">이메일 문의 support@example.go.kr</p>
          </div>
          ...
          <button
            ...
            className="w-full h-[68px] bg-white border border-primary rounded-[16px] text-primary text-[20px] font-semibold cursor-pointer"
          >
            참여 신청하기
          </button>
        </div>
