...
function ProgramComplete() {
  ...
  return (
    ...
    >
      <Header title="프로그램" onBack={() => navigate("/programs")} invert />
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-5 pb-[130px]">
        ...
        <div className="relative w-full max-w-[273px]">
          ...
          <img src={cardTriangle} alt="" className="absolute -top-2 -left-[14px] w-[81px] h-[77px] z-20" style={{ filter: "drop-shadow(0px 5px 14.5px rgba(0, 204, 147, 0.4))" }} />
